...
@section('title', 'Titipan Customer')

@section('content')
<h4 class="py-3 mb-4">
    <span class="text-muted fw-light">Transaksi /</span> Titipan Customer
</h4>
...
<div class="card-datatable table-responsive pt-0">
    <table class="datatables-basic table border-top">
        ...
        <tbody>
            @php
                $sampleData = [
                    ['no_jurnal' => 'TI20239-00149', 'tanggal_transaksi' => '22/09/23', 'customer' => 'ACH RAYHAN BANGKALAN', 'total' => 'Rp 9.150.000,00', 'akun_pembayaran' => 'Bank BRI', 'status' => 'Belum Dipakai'],
